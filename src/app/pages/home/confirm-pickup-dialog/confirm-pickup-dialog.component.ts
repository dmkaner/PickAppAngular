...
@Component({
  selector: 'vex-confirm-pickup-dialog',
  templateUrl: './confirm-pickup-dialog.component.html',
  styleUrls: ['./confirm-pickup-dialog.component.scss']
})
export class ConfirmPickupDialogComponent {
